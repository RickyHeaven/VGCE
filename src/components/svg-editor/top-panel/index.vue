...
<template>
	<div class="flex justify-between" style="width: 100%">
		<div class="flex items-center justify-between" style="width: 220px">
			...
			<el-icon size="22" style="cursor: pointer" @click="svgEditLayoutStore.left_nav = !svgEditLayoutStore.left_nav">
				<svg-analysis v-if="svgEditLayoutStore.left_nav" name="menu-unfold"></svg-analysis>
		...
		<div class="flex justify-between" style="width: calc(100% - 440px)">
			<div class="flex items-center">
				<el-icon
					title="撤销 ctrl+z"
					:size="20"
					:class="`${editPrivateStore.getTopBtnUndoStatus ? 'icon-normal' : 'icon-disable'} ml-20px`"
				...
				>
					<svg-analysis name="import"></svg-analysis>
				</el-icon>
				<el-icon
					title="导出数据模型"
					:size="20"
				...
				>
					<svg-analysis name="export"></svg-analysis>
				</el-icon>
				<!-- <el-divider direction="vertical"></el-divider>
		...
		<div class="flex items-center" style="width: 220px">
			<el-icon size="22" style="cursor: pointer" @click="svgEditLayoutStore.right_nav = !svgEditLayoutStore.right_nav">
				<svg-analysis v-if="svgEditLayoutStore.right_nav" name="menu-fold"></svg-analysis>
