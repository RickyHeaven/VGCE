<template>
	<el-form-item v-for="(attr_item, key) in props.objInfo" :key="key" :label="attr_item.title" size="small">
		<el-select
...
<script setup lang="ts">
	...
	import JsonEdit from '@/components/webtopo-svg-edit/right-panel/json-edit.vue'
